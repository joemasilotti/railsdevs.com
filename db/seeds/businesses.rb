...
if business.user.subscriptions.none?
  ...
  business.user.payment_processor
    .subscribe(plan: Businesses::Subscription.with_identifier(:full_time).stripe_price_id)
end
...
if business.user.subscriptions.none?
  business.user.set_payment_processor(:fake_processor, allow_fake: true)
  business.user.payment_processor
    .subscribe(plan: Businesses::Subscription.with_identifier(:part_time).stripe_price_id)
end
