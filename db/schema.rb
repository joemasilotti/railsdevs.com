...
ActiveRecord::Schema[7.0].define(version: 2023_02_28_215801) do
  ...
  create_table "developers_badges", force: :cascade do |t|
    t.bigint "developer_id", null: false
    t.boolean "recently_active", default: true, null: false
    t.boolean "source_contributor", default: false, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["developer_id"], name: "index_developers_badges_on_developer_id"
  end
  ...
  add_foreign_key "developers_badges", "developers"
