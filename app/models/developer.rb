class Developer < ApplicationRecord
  ...
  validates_numericality_of :preferred_min_hourly_rate, less_than: ->(developer) { developer.preferred_max_hourly_rate }
  ...
  validates_numericality_of :preferred_min_salary, less_than: ->(developer) { developer.preferred_max_salary }
