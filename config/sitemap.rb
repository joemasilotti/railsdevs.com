...
SitemapGenerator::Sitemap.create do
  ...
  Developer.visible.newest_first.find_each do |developer|
    id = Feature.enabled?(:obfuscate_developer_urls, user: nil) ? developer.hashid : developer.id
    add developer_path(id: id), changefreq: "always", priority: 0.8, lastmod: developer.updated_at
  end
