...
class MessageTest < ActiveSupport::TestCase
  ...
  test 'body_html is filled with rendered html version of body' do
    ...
    assert_equal '<p>Check out <a href="https://railsdevs.com/" target="_blank">https://railsdevs.com/</a>!</p>',
                 message.body_html
  end
  ...
  test "user (developer) doesn't have any message" do
    ...
    assert_not Message.first_message?(user.developer)
  end
