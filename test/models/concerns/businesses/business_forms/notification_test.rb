...
class Businesses::BusinessForms::Notifications::NotificationsTest < ActiveSupport::TestCase
  include ActionMailer::TestHelper
  include HireFormsHelper
  include NotificationsHelper

  test "sends a notification to the admins" do
    hire_form = Businesses::BusinessForm.new(form_attributes)
  ...
  test "invalid records don't send notifications" do
    hire_form = Businesses::BusinessForm.new
