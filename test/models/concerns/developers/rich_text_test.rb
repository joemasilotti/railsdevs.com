...
class Developers::RichTextTest < ActiveSupport::TestCase
  test '#rich_text_bio parses bio correctly' do
    ...
    assert_match(%r{<h1>H1</h1>}, developer.rich_text_bio)
  ...
  test '#rich_text_bio disallows manually written HTML tags' do
    ...
    assert_no_match(%r{<h1>Hello world</h1>}, developer.rich_text_bio)
    assert_match(%r{<p>Hello world</p>}, developer.rich_text_bio)
  end
