...
class UpgradeRequiredComponentTest < ViewComponent::TestCase
  ...
  test "expired subscriptions see reactivation copy" do
    ...
    assert_text I18n.t("upgrade_required_component.title.expired")
    assert_text I18n.t("upgrade_required_component.body.expired")
    assert_text I18n.t("upgrade_required_component.cta.expired")
  ...
  test "active subscriptions see upgrade copy" do
    ...
    assert_text I18n.t("upgrade_required_component.title.upgrade")
    assert_text I18n.t("upgrade_required_component.body.upgrade")
    assert_text I18n.t("upgrade_required_component.cta.upgrade")
